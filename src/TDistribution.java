 ...
 */
 public class TDistribution extends ProbabilityDistribution {
         private int dgrFreedom;
         private double logPdfFreedom;
         
         //Tdistribution obj = new Tdistribution(degreesofFreedom);
         ...
         */
         public TDistribution(int r) {
                 if(r<=0)
                         System.out.println("The degrees of freedom must be greater than zero.");
                 dgrFreedom=r;
